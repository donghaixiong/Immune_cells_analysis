...
load('Input.objects.forFig5.RData')
...
ImmuneCells.Sig.GSE78220 <- Test_GSE78220_V5
...
tiff("./output_test/Fig5a_FigS12a_GSE78220_28samples.tiff", width = 7600, height = 7600, units = "px", res = 710)
...
tiff("./output_test/Fig5b_FigS12b_GSE91061_51samples.tiff", width = 7600, height = 7600, units = "px", res = 710)
...
tiff("./output_test/Fig5c_FigS12c_PRJEB23709_73samples.tiff", width = 7600, height = 7600, units = "px", res = 710)
...
tiff("./output_test/Fig5d_FigS12d_MGSP_103samples.tiff", width = 7600, height = 7600, units = "px", res = 710)
